      ...
      <div className="rounded-md border border-gray-200 p-3">
        ...
        <div className="mb-3">
          ...
          <div className="mt-2 text-xs text-gray-500">
            Tip: Write the full question and wrap each correct answer in square brackets. For example: <code>What is the capital of France? [Paris]</code>.<br />
            Every value inside <code>[ ]</code> will automatically become an input field.
          </div>
        </div>
